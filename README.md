...
### Backpack
1. Регистрация: [backpack.exchange](https://backpack.exchange/join/65d923ff-b224-4dfb-aa6c-cd5346c77651)
2. Пройди KYC
3. Пополни счёт (USDC)
...
### Lighter
1. Регистрация: [app.lighter.xyz](https://app.lighter.xyz/?referral=KOHTA) (подключи EVM-кошелёк, например MetaMask)
...
### Hyperliquid
1. Регистрация: [app.hyperliquid.xyz](https://app.hyperliquid.xyz/join/KOHTA)
2. Пополни счёт (USDC через Arbitrum)
...
### GRVT
1. Регистрация: [grvt.io](https://grvt.io/exchange/earn-on-equity?ref=BNZ8NKI)
2. Пополни счёт
...
### Aster
1. Регистрация: [asterdex.com](https://www.asterdex.com/en/referral/rLfLbr)
2. Пополни счёт (USDC)
